...
export const registerPluginThemeCommands = (program: Command) => {
  // Plugins
  program
...
export const registerMonitoringCommands = (program: Command) => {
  program
...
export const registerCollaboratorCommands = (program: Command) => {
  program
